...
const UpcomingTasks = ({ tasks = [], isLoading }) => {
  ...
  const displayTasks = tasks.length > 0 ? tasks : [
    { id: 1, customer: 'PT. Surya Abadi', task: 'Follow up Penawaran Q-2025-0520', date: '2025-05-25', status: 'pending', assigned: 'Andi' },
    { id: 2, customer: 'Bapak Budi Hartono', task: 'Visit Lokasi Instalasi', date: '2025-05-26', status: 'pending', assigned: 'Siska' },
    { id: 3, customer: 'Cafe Kopi Kenangan', task: 'Demo Produk SD-WAN', date: '2025-05-26', status: 'pending', assigned: 'Andi' },
    { id: 4, customer: 'PT. Teknologi Baru', task: 'Kirim Invoice Termin 1', date: '2025-05-27', status: 'pending', assigned: 'Bambang' },
  ];
